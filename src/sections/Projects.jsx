  ...
  return (
    ...
    >
      <div className="w-full h-full lg:px-10 xl:px-20 px-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-8 mt-20">
          {shuffleProjects.map((project, key) => (
            <GlowCard index={key} key={project.title}>
              <div className="group rounded-lg overflow-hidden shadow-xs h-full flex flex-col">
                <div className="overflow-hidden">
                  <ImageCard
                    src={project.image}
                    alt={project.title}
                    css_class="w-full h-full object-cover transition-transform duration-500"
                  />
                </div>
                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="mb-4 subtext text-sm">
                      {project.description}
                    </p>
                  </div>
